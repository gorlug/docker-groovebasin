...
RUN sed -i 's/    "sslKey": "certs\/self-signed-key.pem",//g' /home/groovebasin/groovebasin/config.json; sed -i 's/    "sslCert": "certs\/self-signed-cert.pem",//g' /home/groovebasin/groovebasin/config.json
